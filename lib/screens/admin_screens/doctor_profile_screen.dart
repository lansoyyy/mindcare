...
class AdminDoctorProfileScreen extends StatefulWidget {
  const AdminDoctorProfileScreen({super.key});

  @override
  State<AdminDoctorProfileScreen> createState() =>
      _AdminDoctorProfileScreenState();
}

class _AdminDoctorProfileScreenState extends State<AdminDoctorProfileScreen> {
  @override
